...
B键开弹仓 ctrl加b关弹仓
G开摩擦轮开红外 ctrl加G关摩擦轮关红外
从左往右指示灯
1号灯珠是射速 无数据是蓝灯 大于30m/s是红灯 小于30是绿

2号灯珠是热量指示灯无数据是蓝灯 小于3分之一是绿灯 大于3分之一小于3分之二是黄灯 大于三分之一是红灯

5号灯珠是超电电量判断 大于90是绿  90到70是黄  70到50是红 50以下是蓝
灯

4号灯珠是移速 0不亮，速度增大由绿变红
//小陀螺模式按下E //自瞄预测模式  按下E加ctrl