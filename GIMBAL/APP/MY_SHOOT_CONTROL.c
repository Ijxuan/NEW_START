...
void shoot_control(void)
{
	...
	if (DR16.rc.s_left == 3)
	{
		...
		{
			if(DR16.mouse.z<-1)//滚轮跳开自动开火
			{
vision_aoto_shoot_flag=1;
			}
			if(DR16.mouse.z>1)
			{
vision_aoto_shoot_flag=0;
			}
			//						
//						HAL_GPIO_WritePin(RED_GPIO_Port, RED_Pin, GPIO_PIN_SET);
