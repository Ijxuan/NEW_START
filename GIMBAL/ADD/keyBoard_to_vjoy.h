...
// 在两者之间视为 单击
#define TIME_KeyMouse_LongPress 5 // 超过该时间视为 长按
...
extern keyBoard_PRESS keyBoard_R; // A键的结构体
extern keyBoard_PRESS keyBoard_F; // D键的结构体
...
extern keyBoard_PRESS mouse_Left; // 鼠标左键键的结构体
extern keyBoard_PRESS mouse_Right; // 鼠标右键键的结构体
